...
export default function Navbar({ variant = 'light' }: NavbarProps) {
  ...
  const iconFill = isDark ? '#2C2D30' : '#F6F4F1';
  ...
  return (
    ...
    >
          ...
          <div className="flex gap-[24px]">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g clipPath="url(#clip0_28_298)">
                <path d="M17.0711 12.9289C15.9819 11.8398 14.6855 11.0335 13.2711 10.5454C14.786 9.50199 15.7812 7.75578 15.7812 5.78125C15.7812 2.59348 13.1878 0 10 0C6.81223 0 4.21875 2.59348 4.21875 5.78125C4.21875 7.75578 5.21402 9.50199 6.72898 10.5454C5.31453 11.0335 4.01813 11.8398 2.92895 12.9289C1.0402 14.8177 0 17.3289 0 20H1.5625C1.5625 15.3475 5.34754 11.5625 10 11.5625C14.6525 11.5625 18.4375 15.3475 18.4375 20H20C20 17.3289 18.9598 14.8177 17.0711 12.9289ZM10 10C7.67379 10 5.78125 8.1075 5.78125 5.78125C5.78125 3.455 7.67379 1.5625 10 1.5625C12.3262 1.5625 14.2188 3.455 14.2188 5.78125C14.2188 8.1075 12.3262 10 10 10Z" fill={iconFill} />
              </g>
              <defs>
      ...
      {/* ================= Mobile ================= */}
      <div className="lg:hidden relative flex items-center justify-between px-[18px] h-[62px]">
        ...
        >
          <span className={`absolute top-[6px] left-0 right-0 h-[2px] ${hamburgerColor}`} />
          <span className={`absolute top-[13px] left-0 right-0 h-[2px] ${hamburgerColor}`} />
          <span className={`absolute top-[20px] left-0 right-0 h-[2px] ${hamburgerColor}`} />
        </button>
      </div>
