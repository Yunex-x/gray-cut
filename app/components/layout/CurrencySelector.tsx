...
export default function CurrencySelector({ variant = 'light' }: CurrencySelectorProps) {
  ...
  const textColor = isDark ? 'text-[rgba(44,45,48,0.7)]' : 'text-[rgba(246,244,241,0.7)]';
  const arrowStroke = isDark ? '#2C2D30' : '#F6F4F1';
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        {/* Arrow */}
        <span className={`relative w-[18px] h-[18px] transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`}>
          <svg
            width="18"
            height="18"
            viewBox="0 0 20 20"
