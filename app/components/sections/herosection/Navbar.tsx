    ...
    >
      ...
      <div className="hidden lg:flex flex-col w-full ">
        ...
        <div className="flex items-center justify-between  px-[10px] py-[16px] h-[62px]">
          ...
          {/* Center logo */}
          <Link href="/" className="w-[69px] h-[30px] cursor-pointer group">
            <img 
              src="logo.svg" 
              alt="Logo" 
              className="w-full h-full transition-all duration-300 ease-in-out group-hover:scale-110 group-hover:brightness-110" 
            />
          </Link>
          ...
          <div className="flex items-center gap-[24px]">
            <button
              ...
              className="w-[20px] h-[20px] cursor-pointer transition-all duration-300 ease-in-out hover:scale-110 hover:brightness-125 active:scale-95"
            >
        ...
        <nav className="flex justify-center items-center h-[36px] gap-[24px] px-[40px]">
          <Link href="/" className="text-[#F6F4F1] text-[16px] leading-[19px] font-medium transition-all duration-300 ease-in-out hover:text-white hover:scale-105 active:scale-95">
            Home
          </Link>

          <Link href="/precisionfit" className="text-[rgba(246,244,241,0.7)] text-[16px] leading-[19px] font-medium transition-all duration-300 ease-in-out hover:text-[#F6F4F1] hover:scale-105 active:scale-95">
            PrecisionFit System
          </Link>

          <button className="flex items-center gap-[8px] cursor-pointer transition-all duration-300 ease-in-out hover:scale-105 active:scale-95 group">
            <span className="text-[rgba(246,244,241,0.7)] text-[16px] leading-[19px] font-medium transition-colors duration-300 group-hover:text-[#F6F4F1]">
              Shop
            </span>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" className="transition-transform duration-300 group-hover:translate-y-1">
              <path
                d="M4 7L10 13L16 7"
                stroke="rgba(246,244,241,0.7)"
                strokeWidth="1.5"
                className="transition-colors duration-300 group-hover:stroke-[#F6F4F1]"
              />
            </svg>
          </button>

          <Link href="/why-us" className="text-[rgba(246,244,241,0.7)] text-[16px] leading-[19px] font-medium transition-all duration-300 ease-in-out hover:text-[#F6F4F1] hover:scale-105 active:scale-95">
            Why Us?
          </Link>

          <Link href="/question" className="text-[rgba(246,244,241,0.7)] text-[16px] leading-[19px] font-medium transition-all duration-300 ease-in-out hover:text-[#F6F4F1] hover:scale-105 active:scale-95">
            A Question?
          </Link>

          <Link href="/blog" className="text-[rgba(246,244,241,0.7)] text-[16px] leading-[19px] font-medium transition-all duration-300 ease-in-out hover:text-[#F6F4F1] hover:scale-105 active:scale-95">
            Blog
          </Link>

          <Link href="/location" className="text-[rgba(246,244,241,0.7)] text-[16px] leading-[19px] font-medium transition-all duration-300 ease-in-out hover:text-[#F6F4F1] hover:scale-105 active:scale-95">
            Our Location
          </Link>
        </nav>
      </div>
      ...
      <div className="lg:hidden absolute top-[26px] left-1/2 -translate-x-1/2 w-[393px] md:w-2xl h-[28px] flex items-center justify-between px-[18px] md:px-0">
        ...
        <button className="flex items-center gap-[4px] cursor-pointer transition-all duration-300 ease-in-out hover:scale-105 active:scale-95 group">
          ...
          <span className="text-[16px] leading-[19px] font-medium text-[rgba(246,244,241,0.8)] transition-colors duration-300 group-hover:text-[#F6F4F1]">
            UK
          </span>
        </button>
        ...
        <button 
          ...
          className="w-[28px] h-[28px] relative cursor-pointer transition-all duration-300 ease-in-out hover:scale-110 active:scale-95 group"
        >
          <span className="absolute top-[6px] left-[4px] right-[4px] border-t-[1.5px] border-white transition-all duration-300 group-hover:border-[#8AAE9B]" />
          <span className="absolute top-[13px] left-[4px] right-[4px] border-t-[1.5px] border-white transition-all duration-300 group-hover:border-[#8AAE9B]" />
          <span className="absolute top-[20px] left-[4px] right-[4px] border-t-[1.5px] border-white transition-all duration-300 group-hover:border-[#8AAE9B]" />
        </button>
      </div>
    </header>
  );
